  ...
  pickers
    .new(opts, {
      ...
      attach_mappings = function(prompt_bufnr, map)
        ...
        map("n", config.telescope.mappings.change_branch, change_session_branch)
        map("n", config.telescope.mappings.copy_session, copy_session)
        map("n", config.telescope.mappings.delete_session, _actions.delete_session)
